...
- 온디맨드 벡터 임베딩 기반 법령/판례 검색
- 사용자 질문 → 키워드 추출 → 법령·판례 조회 → 조문 chunk 벡터화 → GPT 답변 생성
- Docker + GitHub Actions로 자동 배포
- **성과:** 검색 속도 단축, GPT 응답 품질 향상  
...
- 일정 저장, 수정, 공유, D-Day 기능
- **성과:** 프리미엄 요금제 호출 제한, API 비용 최적화  
